...
export const KanbanboardCard: React.FC<{ column: ColumnType, cardIndex: number, handleSave: (column: ColumnType) => void }>
  = ({column, cardIndex, handleSave}) => {
  ...
  const handleDelete = (e: React.SyntheticEvent) => {
    ...
    handleSave(updatedColumn);
  };

  const card = column.cards[Number(cardIndex)];

  return (
    <div className="card">
      <div>
        {card.title}
        <span className="card-delete-btn" onClick={handleDelete}>
                        X
                      </span>
      </div>
